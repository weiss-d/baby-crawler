...
from baby_crawler import __version__
from baby_crawler.example import hello
...
app = typer.Typer(
    name="baby-crawler",
    help="A primitive async website crawler.",
...
def version_callback(value: bool):
    ...
    if value:
        console.print(
            f"[yellow]baby-crawler[/] version: [bold blue]{__version__}[/]"
        )
        raise typer.Exit()
...
def main(
    ...
    version: bool = typer.Option(
        ...
        is_eager=True,
        help="Prints the version of the baby-crawler package.",
    ),
):
